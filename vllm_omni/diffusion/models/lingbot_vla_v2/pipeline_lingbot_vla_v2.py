...
from vllm_omni.diffusion.models.interface import SupportActionOutput
...
class LingbotVlaV2Pipeline(nn.Module, SupportActionOutput):
    ...
    @staticmethod
    def _request_prompt(request: OmniDiffusionRequest) -> str:
    ...
    def _noise(self, request: OmniDiffusionRequest) -> torch.Tensor | None:
    ...
    def forward(self, request: OmniDiffusionRequest) -> DiffusionOutput:
        ...
        return DiffusionOutput(output=next(iter(robot_actions.values())))
